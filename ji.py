...
class Config():
    ...
    result_save_path = '/Users/86135/Desktop/1/1' #生成图像保存的路径
    d_net_path = '/Users/86135/Desktop/1/2/1.pth' #判别网络权重文件保存的路径
    g_net_path = '/Users/86135/Desktop/1/2/2.pth' #生成网络权重文件保存的路径
    img_path = '/Users/86135/Desktop/数据/xinggan_face' #源图像文件路径
